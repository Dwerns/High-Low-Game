...
money_amount = Label(root, textvariable = update_money_amount, font = "30").place(x = "250", y = "210")
update_money_change = TK.StringVar()
update_money_change.set("")
money_change = Label(root, textvariable = update_money_change, font = "30").place(x="250", y= "170")
